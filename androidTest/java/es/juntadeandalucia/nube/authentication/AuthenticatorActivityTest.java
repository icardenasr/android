...
public class AuthenticatorActivityTest {
    ...
    public void check_login()
        ...
        // Type user
        onView(ViewMatchers.withId(es.juntadeandalucia.nube.R.id.account_username))
                .perform(typeText(testUser), closeSoftKeyboard());

        // Type user pass
        onView(ViewMatchers.withId(es.juntadeandalucia.nube.R.id.account_password))
                .perform(typeText(testPassword), closeSoftKeyboard());
        onView(ViewMatchers.withId(es.juntadeandalucia.nube.R.id.buttonOK)).perform(click());
