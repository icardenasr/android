...
import es.juntadeandalucia.nube.authentication.OAuth2Constants;
        ...
        try {
            ...
            if (mOAuth2ParsedAuthorizationResponse.keySet().contains(OAuth2Constants.KEY_ERROR)) {
                if (OAuth2Constants.VALUE_ERROR_ACCESS_DENIED.equals(mOAuth2ParsedAuthorizationResponse.get(OAuth2Constants.KEY_ERROR))) {
                    result = new RemoteOperationResult(RemoteOperationResult.ResultCode.OAUTH2_ERROR_ACCESS_DENIED);
                } else {
                    result = new RemoteOperationResult(RemoteOperationResult.ResultCode.OAUTH2_ERROR);
                }
            }
            ...
            } else if (result.getCode() == RemoteOperationResult.ResultCode.OAUTH2_ERROR) {
