...
import es.juntadeandalucia.nube.lib.resources.status.GetRemoteStatusOperation;
        ...
        if (result.isSuccess()) {
            ...
            if (detectAuthResult.isSuccess()) {
                mResultData.mAuthMethod = 
                        (DetectAuthenticationMethodOperation.AuthenticationMethod)detectAuthResult.getData().get(0);
