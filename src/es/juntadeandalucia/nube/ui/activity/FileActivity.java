...
import es.juntadeandalucia.nube.authentication.AccountUtils;
...
import es.juntadeandalucia.nube.files.FileOperationsHelper;
...
import es.juntadeandalucia.nube.lib.common.OwnCloudClient;
...
import es.juntadeandalucia.nube.lib.common.operations.OnRemoteOperationListener;
...
import es.juntadeandalucia.nube.lib.common.operations.RemoteOperationResult.ResultCode;
...
import es.juntadeandalucia.nube.operations.GetSharesForFileOperation;
...
import es.juntadeandalucia.nube.services.OperationsService;
import es.juntadeandalucia.nube.ui.NavigationDrawerItem;
import es.juntadeandalucia.nube.ui.adapter.NavigationDrawerListAdapter;
import es.juntadeandalucia.nube.ui.dialog.ConfirmationDialogFragment;
import es.juntadeandalucia.nube.ui.dialog.LoadingDialog;
import es.juntadeandalucia.nube.ui.dialog.SslUntrustedCertDialog;
...
//    protected boolean mShowAccounts = false;
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (mDrawerToggle != null) {
            ...
            if (isDrawerOpen()) {
                getSupportActionBar().setTitle(es.juntadeandalucia.nube.R.string.app_name);
    ...
    protected void initDrawer(){
        ...
        mDrawerLayout = (DrawerLayout) findViewById(es.juntadeandalucia.nube.R.id.drawer_layout);
        // Notification Drawer
        RelativeLayout navigationDrawerLayout = (RelativeLayout) findViewById(es.juntadeandalucia.nube.R.id.left_drawer);
        mDrawerList = (ListView) navigationDrawerLayout.findViewById(es.juntadeandalucia.nube.R.id.drawer_list);
...
//        }
        ...
        mDrawerTitles = getResources().getStringArray(es.juntadeandalucia.nube.R.array.drawer_items);

        // nav drawer content description from resources
        mDrawerContentDescriptions = getResources().
                getStringArray(es.juntadeandalucia.nube.R.array.drawer_content_descriptions);
        ...
        mDrawerItems.add(new NavigationDrawerItem(mDrawerTitles[0], mDrawerContentDescriptions[0],
                es.juntadeandalucia.nube.R.drawable.ic_folder_open));
        ...
        mDrawerItems.add(new NavigationDrawerItem(mDrawerTitles[1], mDrawerContentDescriptions[2],
                es.juntadeandalucia.nube.R.drawable.ic_uploads));

        // Settings
        mDrawerItems.add(new NavigationDrawerItem(mDrawerTitles[2], mDrawerContentDescriptions[1],
                es.juntadeandalucia.nube.R.drawable.ic_settings));
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout, es.juntadeandalucia.nube.R.string.drawer_open, es.juntadeandalucia.nube.R.string.drawer_close) {
    ...
    protected void setUsernameInDrawer(View navigationDrawerLayout, Account account) {
        if (navigationDrawerLayout != null && account != null) {
            TextView username = (TextView) navigationDrawerLayout.findViewById(es.juntadeandalucia.nube.R.id.drawer_username);
            int lastAtPos = account.name.lastIndexOf("@");
            username.setText(account.name.substring(0, lastAtPos));
        }
    }
    ...
    protected String getDefaultTitle() {
        return getString(es.juntadeandalucia.nube.R.string.default_display_name_for_root_folder);
    }
    ...
    protected void requestCredentialsUpdate(Context context, Account account) {
        ...
        try {
            ...
            Toast.makeText(context, es.juntadeandalucia.nube.R.string.auth_account_does_not_exist, Toast.LENGTH_SHORT).show();
        }
    ...
    public void onFailedSavingCertificate() {
        ConfirmationDialogFragment dialog = ConfirmationDialogFragment.newInstance(
            es.juntadeandalucia.nube.R.string.ssl_validator_not_saved, new String[]{}, 0, es.juntadeandalucia.nube.R.string.common_ok, -1, -1
        );
