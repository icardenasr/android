...
import es.juntadeandalucia.nube.authentication.AccountAuthenticator;
...
import es.juntadeandalucia.nube.ui.adapter.UploaderAdapter;
import es.juntadeandalucia.nube.ui.dialog.ConfirmationDialogFragment;
import es.juntadeandalucia.nube.ui.dialog.CreateFolderDialogFragment;
import es.juntadeandalucia.nube.ui.asynctasks.CopyAndUploadContentUrisTask;
...
public class ReceiveExternalFilesActivity extends FileActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mAccountSelected) {
            setAccount((Account) savedInstanceState.getParcelable(EXTRA_ACCOUNT));
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable(EXTRA_ACCOUNT, getAccount());
