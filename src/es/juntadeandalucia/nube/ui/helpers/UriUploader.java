 ...
 *
 */
package es.juntadeandalucia.nube.ui.helpers;
...
public class UriUploader {
    ...
    private String generateDiplayName() {
        return mActivity.getString(es.juntadeandalucia.nube.R.string.common_unknown) +
    ...
    private void copyThenUpload(Uri[] sourceUris, String[] remotePaths) {
        if (mShowWaitingDialog) {
            mActivity.showLoadingDialog(mActivity.getResources().
                    getString(es.juntadeandalucia.nube.R.string.wait_for_tmp_copy_from_private_storage));
        }
