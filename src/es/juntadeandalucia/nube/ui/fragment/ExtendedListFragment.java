...
import es.juntadeandalucia.nube.ui.ExtendedListView;
import es.juntadeandalucia.nube.ui.activity.OnEnforceableRefreshListener;
import es.juntadeandalucia.nube.ui.adapter.FileListListAdapter;
...
public class ExtendedListFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(es.juntadeandalucia.nube.R.layout.list_fragment, null);

        mListView = (ExtendedListView)(v.findViewById(es.juntadeandalucia.nube.R.id.list_root));
        mListView.setOnItemClickListener(this);
        mListFooterView = inflater.inflate(es.juntadeandalucia.nube.R.layout.list_footer, null, false);

        mGridView = (GridViewWithHeaderAndFooter) (v.findViewById(es.juntadeandalucia.nube.R.id.grid_root));
        mGridView.setNumColumns(GridView.AUTO_FIT);
        mGridView.setOnItemClickListener(this);
        mGridFooterView = inflater.inflate(es.juntadeandalucia.nube.R.layout.list_footer, null, false);
        ...
        mRefreshListLayout = (SwipeRefreshLayout) v.findViewById(es.juntadeandalucia.nube.R.id.swipe_containing_list);
        mRefreshGridLayout = (SwipeRefreshLayout) v.findViewById(es.juntadeandalucia.nube.R.id.swipe_containing_grid);
        mRefreshEmptyLayout = (SwipeRefreshLayout) v.findViewById(es.juntadeandalucia.nube.R.id.swipe_containing_empty);
        mEmptyListMessage = (TextView) v.findViewById(es.juntadeandalucia.nube.R.id.empty_list_view);
        ...
        mFabMain = (FloatingActionsMenu) v.findViewById(es.juntadeandalucia.nube.R.id.fab_main);
        mFabUpload = (FloatingActionButton) v.findViewById(es.juntadeandalucia.nube.R.id.fab_upload);
        mFabMkdir = (FloatingActionButton) v.findViewById(es.juntadeandalucia.nube.R.id.fab_mkdir);
        mFabUploadFromApp = (FloatingActionButton) v.findViewById(es.juntadeandalucia.nube.R.id.fab_upload_from_app);
    ...
    protected void onCreateSwipeToRefresh(SwipeRefreshLayout refreshLayout) {
        ...
        refreshLayout.setColorSchemeResources(es.juntadeandalucia.nube.R.color.color_accent, es.juntadeandalucia.nube.R.color.primary,
                es.juntadeandalucia.nube.R.color.primary_dark);
    ...
    protected void setFooterText(String text) {
        if (text != null && text.length() > 0) {
            ((TextView)mListFooterView.findViewById(es.juntadeandalucia.nube.R.id.footerText)).setText(text);
            ((TextView)mGridFooterView.findViewById(es.juntadeandalucia.nube.R.id.footerText)).setText(text);
