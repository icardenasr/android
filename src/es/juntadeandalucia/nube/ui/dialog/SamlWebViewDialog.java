...
import es.juntadeandalucia.nube.authentication.SsoWebViewClient;
...
public class SamlWebViewDialog extends DialogFragment {
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mSsoWebViewClientListener = (SsoWebViewClient.SsoWebViewClientListener) activity;
            mHandler = new Handler();
            mWebViewClient = new SsoWebViewClient(activity, mHandler, mSsoWebViewClientListener);
            
       } catch (ClassCastException e) {
            throw new ClassCastException(activity.toString() + " must implement " +
                    SsoWebViewClient.SsoWebViewClientListener.class.getSimpleName());
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NO_TITLE, es.juntadeandalucia.nube.R.style.Theme_ownCloud_Dialog);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RelativeLayout ssoRootView = (RelativeLayout) inflater.inflate(es.juntadeandalucia.nube.R.layout.sso_dialog,
