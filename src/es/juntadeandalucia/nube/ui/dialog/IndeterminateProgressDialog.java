...
public class IndeterminateProgressDialog extends DialogFragment {
    ...
    public static IndeterminateProgressDialog newInstance(int messageId, boolean cancelable) {
        ...
        fragment.setStyle(DialogFragment.STYLE_NO_FRAME, es.juntadeandalucia.nube.R.style.ownCloud_AlertDialog);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(getActivity(), es.juntadeandalucia.nube.R.style.ProgressDialogTheme);
        progressDialog.setIndeterminate(true);
        progressDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            @Override
            public void onShow(DialogInterface dialog) {
                ProgressBar v = (ProgressBar) progressDialog.findViewById(android.R.id.progress);
                v.getIndeterminateDrawable().setColorFilter(getResources().getColor(es.juntadeandalucia.nube.R.color.color_accent),
        ...
        /// set message
        int messageId = getArguments().getInt(ARG_MESSAGE_ID, es.juntadeandalucia.nube.R.string.placeholder_sentence);
