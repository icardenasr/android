...
import es.juntadeandalucia.nube.ui.adapter.CertificateCombinedExceptionViewAdapter;
import es.juntadeandalucia.nube.ui.adapter.SslCertificateViewAdapter;
import es.juntadeandalucia.nube.ui.adapter.SslErrorViewAdapter;
import es.juntadeandalucia.nube.ui.adapter.X509CertificateViewAdapter;
...
public class SslUntrustedCertDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mView == null) {
            mView = inflater.inflate(es.juntadeandalucia.nube.R.layout.ssl_untrusted_cert_layout, container,  false);
        ...
        Button ok = (Button) mView.findViewById(es.juntadeandalucia.nube.R.id.ok);
        ok.setOnClickListener(new OnCertificateTrusted());
        
        Button cancel = (Button) mView.findViewById(es.juntadeandalucia.nube.R.id.cancel);
        cancel.setOnClickListener(new OnCertificateNotTrusted());
        
        Button details = (Button) mView.findViewById(es.juntadeandalucia.nube.R.id.details_btn);
        details.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                View detailsScroll = mView.findViewById(es.juntadeandalucia.nube.R.id.details_scroll);
