...
implements ConfirmationDialogFragment.ConfirmationDialogFragmentListener {
    ...
    public static RemoveFileDialogFragment newInstance(OCFile file) {
        ...
        int messageStringId = es.juntadeandalucia.nube.R.string.confirmation_remove_alert;
        
        int negBtn = -1;
        if (file.isFolder()) {
            messageStringId = es.juntadeandalucia.nube.R.string.confirmation_remove_folder_alert;
            negBtn = es.juntadeandalucia.nube.R.string.confirmation_remove_local;
        } else if (file.isDown()) {
            negBtn = es.juntadeandalucia.nube.R.string.confirmation_remove_local;
        }
        ...
        args.putInt(ARG_POSITIVE_BTN_RES, es.juntadeandalucia.nube.R.string.common_yes);
        args.putInt(ARG_NEUTRAL_BTN_RES, es.juntadeandalucia.nube.R.string.common_no);
