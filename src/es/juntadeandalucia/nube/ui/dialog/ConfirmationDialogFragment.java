...
public class ConfirmationDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(), es.juntadeandalucia.nube.R.style.Theme_ownCloud_Dialog)
            .setIcon(es.juntadeandalucia.nube.R.drawable.ic_warning)
