 ...
 *
 */
package es.juntadeandalucia.nube.ui.errorhandling;
...
public class ErrorShowActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(es.juntadeandalucia.nube.R.layout.errorhandling_showerror);
		mError = (TextView) findViewById(es.juntadeandalucia.nube.R.id.errorTextView);
