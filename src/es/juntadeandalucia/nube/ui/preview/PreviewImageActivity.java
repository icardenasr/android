...
public class PreviewImageActivity extends FileActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(es.juntadeandalucia.nube.R.layout.preview_image_activity);
        ...
        if (isHoneycombOrHigher()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(getResources().getColor(es.juntadeandalucia.nube.R.color.owncloud_blue_dark_transparent));
            }
        }
    ...
    private void initViewPager() {
        ...
        mViewPager = (ExtendedViewPager) findViewById(es.juntadeandalucia.nube.R.id.fragmentPager);
