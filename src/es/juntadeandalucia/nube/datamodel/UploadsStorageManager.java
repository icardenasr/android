...
public class UploadsStorageManager extends Observable {
    ...
    public long storeUpload(OCUpload ocUpload) {
        ...
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_LOCAL_PATH, ocUpload.getLocalPath());
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_REMOTE_PATH, ocUpload.getRemotePath());
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_ACCOUNT_NAME, ocUpload.getAccountName());
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_FILE_SIZE, ocUpload.getFileSize());
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS, ocUpload.getUploadStatus().value);
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_LOCAL_BEHAVIOUR, ocUpload.getLocalAction());
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_FORCE_OVERWRITE, ocUpload.isForceOverwrite() ? 1 : 0);
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_IS_CREATE_REMOTE_FOLDER, ocUpload.isCreateRemoteFolder() ? 1 : 0);
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT, ocUpload.getLastResult().getValue());
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_CREATED_BY, ocUpload.getCreadtedBy());

        Uri result = getDB().insert(ProviderMeta.ProviderTableMeta.CONTENT_URI_UPLOADS, cv);
    ...
    public int updateUpload(OCUpload ocUpload) {
        ...
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS, ocUpload.getUploadStatus().value);
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT, ocUpload.getLastResult().getValue());
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_UPLOAD_END_TIMESTAMP, ocUpload.getUploadEndTimestamp());

        int result = getDB().update(ProviderMeta.ProviderTableMeta.CONTENT_URI_UPLOADS,
            cv,
    ...
    private int updateUploadInternal(Cursor c, UploadStatus status, UploadResult result, String remotePath,
        ...
        while (c.moveToNext()) {
            ...
            String path = c.getString(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_LOCAL_PATH));
            Log_OC.v(
                TAG,
    ...
    public int removeUpload(String accountName, String remotePath) {
        int result = getDB().delete(
                ProviderMeta.ProviderTableMeta.CONTENT_URI_UPLOADS,
                ProviderMeta.ProviderTableMeta.UPLOADS_ACCOUNT_NAME + "=? AND " + ProviderMeta.ProviderTableMeta.UPLOADS_REMOTE_PATH + "=?" ,
    ...
    private OCUpload createOCUploadFromCursor(Cursor c) {
        ...
        if (c != null) {
            String localPath = c.getString(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_LOCAL_PATH));
            String remotePath = c.getString(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_REMOTE_PATH));
            String accountName = c.getString(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_ACCOUNT_NAME));
            upload = new OCUpload(localPath, remotePath, accountName);

            upload.setFileSize(c.getLong(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_FILE_SIZE)));
            upload.setUploadId(c.getLong(c.getColumnIndex(ProviderMeta.ProviderTableMeta._ID)));
            upload.setUploadStatus(
                    UploadStatus.fromValue(c.getInt(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS)))
            );
            upload.setLocalAction(c.getInt(c.getColumnIndex((ProviderMeta.ProviderTableMeta.UPLOADS_LOCAL_BEHAVIOUR))));
            upload.setForceOverwrite(c.getInt(
                    c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_FORCE_OVERWRITE)) == 1);
            upload.setCreateRemoteFolder(c.getInt(
                    c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_IS_CREATE_REMOTE_FOLDER)) == 1);
            upload.setUploadEndTimestamp(c.getLong(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_UPLOAD_END_TIMESTAMP)));
            upload.setLastResult(UploadResult.fromValue(
                    c.getInt(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT))));
            upload.setCreatedBy(c.getInt(c.getColumnIndex(ProviderMeta.ProviderTableMeta.UPLOADS_CREATED_BY)));
        }
        return upload;
    }
    ...
    public OCUpload[] getCurrentAndPendingUploads() {
        return getUploads(
            ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_IN_PROGRESS.value + " OR " +
            ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT + "==" + UploadResult.DELAYED_FOR_WIFI.getValue(),
            null
        );
    }
    ...
    public OCUpload[] getFailedUploads() {
        return getUploads(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_FAILED.value, null);
    }
    ...
    public OCUpload[] getFinishedUploads() {
        return getUploads(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_SUCCEEDED.value, null);
    }
    ...
    public OCUpload[] getFailedButNotDelayedForWifiUploads() {
        return getUploads(
            ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "==" + UploadStatus.UPLOAD_FAILED.value + " AND " +
                ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT + "<>" + UploadResult.DELAYED_FOR_WIFI.getValue(),
            null
        );
    }
    ...
    public long clearSuccessfulUploads() {
        long result = getDB().delete(
                ProviderMeta.ProviderTableMeta.CONTENT_URI_UPLOADS,
                ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "=="+ UploadStatus.UPLOAD_SUCCEEDED.value, null
        );
    ...
    public long clearAllFinishedButNotDelayedForWifiUploads() {
        ...
        long result = getDB().delete(
                ProviderMeta.ProviderTableMeta.CONTENT_URI_UPLOADS,
                ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "=? OR " + ProviderMeta.ProviderTableMeta.UPLOADS_STATUS + "=? AND " +
                ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT + "<>" + UploadResult.DELAYED_FOR_WIFI.getValue(),
                whereArgs
        );
    ...
    public int failInProgressUploads(UploadResult fail) {
        ...
        ContentValues cv = new ContentValues();
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_STATUS, UploadStatus.UPLOAD_FAILED.getValue());
        cv.put(
            ProviderMeta.ProviderTableMeta.UPLOADS_LAST_RESULT,
            fail != null ? fail.getValue() : UploadResult.UNKNOWN.getValue()
        );
        cv.put(ProviderMeta.ProviderTableMeta.UPLOADS_UPLOAD_END_TIMESTAMP, Calendar.getInstance().getTimeInMillis());
