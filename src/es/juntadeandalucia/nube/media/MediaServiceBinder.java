...
package es.juntadeandalucia.nube.media;
...
public class MediaServiceBinder extends Binder implements MediaController.MediaPlayerControl {
    ...
    public boolean isPlaying() {
        ...
        return (currentState == MediaService.State.PLAYING || (currentState == MediaService.State.PREPARING && mService.mPlayOnPrepared));
    }
    ...
    public void seekTo(int pos) {
        ...
        MediaPlayer currentPlayer = mService.getPlayer();
        MediaService.State currentState = mService.getState();
        if (currentPlayer != null && currentState != MediaService.State.PREPARING && currentState != MediaService.State.STOPPED) {
